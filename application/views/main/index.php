        ...
        <div class="fullwidthbanner-container slider-main">
            <div class="fullwidthabnner">
                <ul id="revolutionul" style="display:none;">            
                        <!-- THE FIRST SLIDE -->
                        <li data-transition="fade" data-slotamount="8" data-masterspeed="700" data-delay="9400" data-thumb="<?=URL::Base()?>static1/img/sliders/revolution/thumbs/thumb2.jpg">
                            <!-- THE MAIN IMAGE IN THE FIRST SLIDE -->
                            <img src="<?=URL::Base()?>static1//img/sliders/revolution/bg1.jpg" alt="">
                            ...
                            <div class="caption lfb"
                                 ...
                                 data-start="1000" 
                                 data-easing="easeOutExpo"  >
                                 <img src="<?=URL::Base()?>static1/img/sliders/revolution/man-winner.png" alt="Image 1">
                            </div>
                        </li>

                        <!-- THE SECOND SLIDE -->
                        <li data-transition="fade" data-slotamount="7" data-masterspeed="300" data-delay="9400" data-thumb="<?=URL::Base()?>static1/img/sliders/revolution/thumbs/thumb2.jpg">                        
                            <img src="<?=URL::Base()?>static1/img/sliders/revolution/bg2.jpg" alt="">
                            ...
                            <div class="caption lfr slide_item_right" 
                                 ...
                                 <img src="<?=URL::Base()?>static1/img/sliders/revolution/mac.png" alt="Image 1">
                            </div>
                            <div class="caption lfr slide_item_right" 
                                 data-x="580" 
                                 data-y="245" 
                                 ...
                                 data-start="2000" 
                                 data-easing="easeOutBack">
                                 <img src="<?=URL::Base()?>static1/img/sliders/revolution/ipad.png" alt="Image 1">
                            </div>
                            <div class="caption lfr slide_item_right" 
                                 data-x="735" 
                                 data-y="290" 
                                 ...
                                 data-start="2500" 
                                 data-easing="easeOutBack">
                                 <img src="<?=URL::Base()?>static1/img/sliders/revolution/iphone.png" alt="Image 1">
                            </div>
                            <div class="caption lfr slide_item_right" 
                                 data-x="835" 
                                 data-y="230" 
                                 ...
                                 data-start="3000" 
                                 data-easing="easeOutBack">
                                 <img src="<?=URL::Base()?>static1/img/sliders/revolution/macbook.png" alt="Image 1">
                            </div>
                            <div class="caption lft slide_item_right" 
                                 ...
                                 data-start="5000" 
                                 data-easing="easeOutBack">
                                 <img src="<?=URL::Base()?>static1/img/sliders/revolution/hint1-blue.png" id="rev-hint1" alt="Image 1">
                            </div>                        
                            <div class="caption lfb slide_item_right" 
                                 ...
                                 data-start="5500" 
                                 data-easing="easeOutBack">
                                 <img src="<?=URL::Base()?>static1/img/sliders/revolution/hint2-blue.png" id="rev-hint2" alt="Image 1">
                            </div>
                        ...
                        <!-- THE THIRD SLIDE -->
                        <li data-transition="fade" data-slotamount="8" data-masterspeed="700" data-delay="9400" data-thumb="<?=URL::Base()?>static1/img/sliders/revolution/thumbs/thumb2.jpg">
                            <img src="<?=URL::Base()?>static1/img/sliders/revolution/bg3.jpg" alt="">
                        ...
                        <li data-transition="fade" data-slotamount="8" data-masterspeed="700" data-delay="9400" data-thumb="<?=URL::Base()?>static1/img/sliders/revolution/thumbs/thumb2.jpg">
                            <!-- THE MAIN IMAGE IN THE FIRST SLIDE -->
                            <img src="<?=URL::Base()?>static1/img/sliders/revolution/bg4.jpg" alt="">                        
                            ...
                            <div class="caption lft start"  
                                 ...
                                 data-start="2000" 
                                 data-easing="easeOutBack"  >
                                 <img src="<?=URL::Base()?>static1/img/sliders/revolution/iphone_left.png" alt="Image 2">
                            </div>
                            ...
                            <div class="caption lft start"  
                                 ...
                                 data-start="2400" 
                                 data-easing="easeOutBack"  >
                                 <img src="<?=URL::Base()?>static1/img/sliders/revolution/iphone_right.png" alt="Image 3">
                            </div>                        
                        </li>
                </ul>
