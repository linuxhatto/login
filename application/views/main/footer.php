    ...
    <script src="<?=URL::Base()?>static/plugins/jquery-migrate-1.2.1.min.js" type="text/javascript"></script>
    <script src="<?=URL::Base()?>static/plugins/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
    <script type="text/javascript" src="<?=URL::Base()?>static/plugins/back-to-top.js"></script>    
 
    <script type="text/javascript" src="<?=URL::Base()?>static/plugins/fancybox/source/jquery.fancybox.pack.js"></script>    
    <script type="text/javascript" src="<?=URL::Base()?>static/plugins/hover-dropdown.js"></script>
    <script type="text/javascript" src="<?=URL::Base()?>static/plugins/revolution_slider/rs-plugin/js/jquery.themepunch.plugins.min.js"></script>
    <script type="text/javascript" src="<?=URL::Base()?>static/plugins/revolution_slider/rs-plugin/js/jquery.themepunch.revolution.min.js"></script> 
    <!--[if lt IE 9]>
    <script src="assets/plugins/respond.min.js"></script>  
    <![endif]-->   
    <!-- END CORE PLUGINS -->   
 
    <script src="<?=URL::Base()?>static/plugins/jquery-1.10.1.min.js" type="text/javascript"></script>
    <script type="text/javascript" src="<?=URL::Base()?>static/plugins/bxslider/jquery.bxslider.js"></script>
    <script src="<?=URL::Base()?>static/scripts/app.js"></script>
    <script src="<?=URL::Base()?>static/scripts/index.js"></script>    
